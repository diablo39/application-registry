      ...
      <v-col>
        <v-card>
          ...
          <v-card-text>
            ...
            <v-view-details-row label="Environment" :value="item.env"></v-view-details-row>
...
<!--              <tr v-if="!ds.isLoading && !ds.isError">-->
<!--                <td v-for="header in headers" :key="header.value">-->
<!--                  <v-text-field-->
<!--                      v-if="header.filterable === true || header.filterable === undefined"-->
<!--                      v-model="ds.filters[header.value]"-->
<!--                      type="text"-->
<!--                      label-->
<!--                      dense-->
<!--                  ></v-text-field>-->
...
<!--            </template>-->
            ...
            <template v-slot:item.operatingSystem="{ item }">{{ item['operating-system-distribution'] }} {{ item['operating-system-version']}}</template>

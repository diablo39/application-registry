...
{
    internal class Info : DbContextOptionsExtensionInfo
    {
        public override bool IsDatabaseProvider => true;

        public override string LogFragment => "SampleDataExtension";
        ...
        public Info(IDbContextOptionsExtension extension)
            :base(extension)
        {
        }
    }

    internal class SampleDataExtension : IDbContextOptionsExtension, ISampleDataProvider
    {
        public DbContextOptionsExtensionInfo Info => new Info(this);

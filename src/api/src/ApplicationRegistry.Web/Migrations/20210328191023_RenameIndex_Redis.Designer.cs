...
namespace ApplicationRegistry.Web.Migrations
{
    ...
    [Migration("20210328191023_RenameIndex_Redis")]
    partial class RenameIndex_Redis
    {
            ...
            modelBuilder.Entity("ApplicationRegistry.Domain.Entities.Redis.RedisDeploymentTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "SENTINEL",
                            CreateDate = new DateTime(1900, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("ApplicationRegistry.Database.Entities.MapAutorestClientTaskEntity", b =>
                {
                    ...
                    b.Navigation("ApplicationVersionDependency");

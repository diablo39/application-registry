...
namespace ApplicationRegistry.Web.Migrations
{
    ...
    [Migration("20190116184249_InitialCreate")]
            ...
            modelBuilder.Entity("ApplicationRegistry.Database.Entities.DependencyTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "NUGET", CanBeAddedManualy = false, CreateDate = new DateTime(2019, 1, 16, 19, 42, 49, 380, DateTimeKind.Local), Name = "Nuget" },
                        new { Id = "APPLICATION", CanBeAddedManualy = true, CreateDate = new DateTime(2019, 1, 16, 19, 42, 49, 385, DateTimeKind.Local), Name = "Application" },
                        new { Id = "EXTERNALAPPLICATION", CanBeAddedManualy = false, CreateDate = new DateTime(2019, 1, 16, 19, 42, 49, 385, DateTimeKind.Local), Name = "External Application" },
                        new { Id = "FRAMEWORK", CanBeAddedManualy = false, CreateDate = new DateTime(2019, 1, 16, 19, 42, 49, 385, DateTimeKind.Local), Name = "Framework" },
                        new { Id = "NPM", CanBeAddedManualy = false, CreateDate = new DateTime(2019, 1, 16, 19, 42, 49, 385, DateTimeKind.Local), Name = "npm" },
                        new { Id = "DATABASE", CanBeAddedManualy = false, CreateDate = new DateTime(2019, 1, 16, 19, 42, 49, 385, DateTimeKind.Local), Name = "Database" },
                        new { Id = "AUTORESTCLIENT", CanBeAddedManualy = false, CreateDate = new DateTime(2019, 1, 16, 19, 42, 49, 385, DateTimeKind.Local), Name = "AutoRest Client" }
                    );
                });
            ...
            modelBuilder.Entity("ApplicationRegistry.Database.Entities.ProjectEntity", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("00000000-0000-0000-0000-000000000001"), CreateDate = new DateTime(2019, 1, 16, 19, 42, 49, 386, DateTimeKind.Local), Description = "Project for applications generated by CLI", Name = "Unasigned applications" }
                    );
                });

...
namespace ApplicationRegistry.Web.Migrations
{
    ...
    [Migration("20190411164452_ApplicationVersion_FailedIndicators")]
    partial class ApplicationVersion_FailedIndicators
    {
            ...
            modelBuilder.Entity("ApplicationRegistry.Database.Entities.ApplicationVersionEntity", b =>
                {
                    ...
                    b.Property<bool?>("DependencyFillectionFailed");
                    ...
                    b.Property<bool?>("SpecificationGenerationFailed");
            ...
            modelBuilder.Entity("ApplicationRegistry.Database.Entities.DependencyTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "NUGET", CanBeAddedManualy = false, CreateDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Nuget" },
                        new { Id = "APPLICATION", CanBeAddedManualy = true, CreateDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Application" },
                        new { Id = "EXTERNALAPPLICATION", CanBeAddedManualy = false, CreateDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "External Application" },
                        new { Id = "FRAMEWORK", CanBeAddedManualy = false, CreateDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Framework" },
                        new { Id = "NPM", CanBeAddedManualy = false, CreateDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "npm" },
                        new { Id = "DATABASE", CanBeAddedManualy = false, CreateDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Database" },
                        new { Id = "AUTORESTCLIENT", CanBeAddedManualy = false, CreateDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "AutoRest Client" },
                        new { Id = "MESSAGEBROKERCONSUMER", CanBeAddedManualy = false, CreateDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Message Broker Topic Consumer" },
                        new { Id = "MESSAGEBROKERPRODUCER", CanBeAddedManualy = false, CreateDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Message Broker Topic Producer" }
                    );
                });
            ...
            modelBuilder.Entity("ApplicationRegistry.Database.Entities.ProjectEntity", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("00000000-0000-0000-0000-000000000001"), CreateDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Description = "Project for applications generated by CLI", Name = "Unasigned applications" }
                    );
                });
            ...
            modelBuilder.Entity("ApplicationRegistry.Database.Entities.SpecificationTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "Swagger", CreateDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Swagger" }
                    );
                });
            ...
            modelBuilder.Entity("ApplicationRegistry.Database.Entities.SwaggerApplicationVersionSpecificationEntity", b =>
                {
                    ...
                    b.ToTable("SwaggerApplicationVersionSpecificationEntity");
            ...
            modelBuilder.Entity("ApplicationRegistry.Database.Entities.ApplicationDependencyEntity", b =>
                {
                    ...
                    b.ToTable("ApplicationDependencyEntity");
            ...
            modelBuilder.Entity("ApplicationRegistry.Database.Entities.AutorestClientDependency", b =>
                {
                    ...
                    b.ToTable("AutorestClientDependency");
            ...
            modelBuilder.Entity("ApplicationRegistry.Database.Entities.MessageBrokerTopicConsumerDependency", b =>
                {
                    ...
                    b.ToTable("MessageBrokerTopicConsumerDependency");
            ...
            modelBuilder.Entity("ApplicationRegistry.Database.Entities.MessageBrokerTopicProducentDependency", b =>
                {
                    ...
                    b.ToTable("MessageBrokerTopicProducentDependency");
            ...
            modelBuilder.Entity("ApplicationRegistry.Database.Entities.MapAutorestClientTaskEntity", b =>
                {
                    ...
                    b.ToTable("MapAutorestClientTaskEntity");
